...
mod tests {
    ...
    fn decode_column_blob_preserves_interior_nul() {
        assert_eq!(decode_column(ColumnKind::Blob, 3, b"a\0b"), String::from("a\0b"));
    }
    ...
    fn decode_column_blob_ignores_overallocated_buffer() {
        ...
        assert_eq!(decode_column(ColumnKind::Blob, 3, bytes), String::from("a\0b"));
    }

    #[test]
    fn decode_column_text_trims_trailing_nul() {
        assert_eq!(decode_column(ColumnKind::Text, 4, b"name\0junk"), String::from("name"));
    }
}
